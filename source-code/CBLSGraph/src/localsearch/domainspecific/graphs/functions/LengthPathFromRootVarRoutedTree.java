...
public class LengthPathFromRootVarRoutedTree implements GFunction {

	public LengthPathFromRootVarRoutedTree(VarRootedTree vt, Node u, int idxWeight){
		// length (w.r.t to idxWeight) of the path from the root of vt to node u on vt
	}
	@Override
